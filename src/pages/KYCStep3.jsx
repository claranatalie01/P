...
import { ClipboardList, ArrowRight, ArrowLeft, Shield, CheckCircle2, Loader2, PartyPopper } from "lucide-react";
...
export default function KYCStep3() {
  ...
  const canSubmit = purpose && activity && income;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0EA5E9] via-[#0284C7] to-[#0369A1] flex items-center justify-center px-6">
        ...
        >
          ...
          >
            Your account has been verified. Welcome to Pasa!
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="bg-gradient-to-r from-[#0EA5E9] to-[#0284C7] px-6 pt-12 pb-20">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-8">
            <Link to={createPageUrl("KYCStep2")}>
      ...
      <div className="px-6 -mt-12 pb-8 max-w-md mx-auto">
        <OnboardingCard>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#1E3A5F]">Quick Profile</h1>
              <p className="text-sm text-[#64748B]">Help us serve you better</p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <Select value={purpose} onValueChange={setPurpose}>
                <SelectTrigger className="h-12 rounded-xl border-[#E2E8F0] focus:ring-[#0EA5E9]/20">
                  <SelectValue placeholder="What will you use Pasa for?" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="personal">Personal Payments</SelectItem>
            ...
            <div>
              ...
              <Select value={activity} onValueChange={setActivity}>
                <SelectTrigger className="h-12 rounded-xl border-[#E2E8F0] focus:ring-[#0EA5E9]/20">
                  <SelectValue placeholder="How often will you transact?" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="low">1-5 transactions</SelectItem>
                  <SelectItem value="medium">6-20 transactions</SelectItem>
                  <SelectItem value="high">21-50 transactions</SelectItem>
                  <SelectItem value="very-high">50+ transactions</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Select value={income} onValueChange={setIncome}>
                ...
                <SelectContent>
                  <SelectItem value="below-20k">Below HKD 20,000</SelectItem>
                  <SelectItem value="20k-50k">HKD 20,000 - 50,000</SelectItem>
                  <SelectItem value="50k-100k">HKD 50,000 - 100,000</SelectItem>
                  <SelectItem value="100k-plus">Above HKD 100,000</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center gap-2 p-3 bg-[#F0F9FF] rounded-xl">
            ...
            <span className="text-xs text-[#64748B]">Background risk assessment in progress</span>
